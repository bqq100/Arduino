...
ifndef RESET_CMD
    ...
    ifneq ($(CATERINA),)
       RESET_CMD = $(ARD_RESET_ARDUINO) --caterina $(ARD_RESET_OPTS) $(call get_reset_port)
    else
       RESET_CMD = $(ARD_RESET_ARDUINO) $(ARD_RESET_OPTS) $(call get_reset_port)
    endif
endif
...
#get_reset_port = $(if $(wildcard $(RESET_PATH)),$(firstword $(wildcard $(RESET_PATH))),$(error Arduino port $(RESET_PATH) not found!))
get_reset_port = $(RESET_PATH)
